...
#define __NUMBER_OF_RANDOM_POINTS__ 2048
...
int main()
{
	...
	//Could we trigger computeGradientAndIntercept in StraightLine
	//Whenever m_X or m_Y of a Point2D is changed?
	//Yes, if the runtime/interpreter has introspection/reflection capacities
	// + Marshalling (Police of all objects) --> .NET environment (C#)
	// So complex, that object immutability is preferable
	C[0] = 90;
	...
	cout << "************* End of ex. with stack variables *************" << endl << endl;
	...
	*pBSecond = "B''";
	...
	//This sample uses a random device equiped with a 32-bit Mersenne Twister Pseudo-Random Number generator
	...
	std::mt19937 objRandomGenerator(objRandomDevice());
